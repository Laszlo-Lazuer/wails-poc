...
func DoSelfUpdate() bool {
	...
	latest, err := selfupdate.UpdateSelf(v, "laszlo-lazuer/wails-poc")
	if err != nil {
...
func DoSelfUpdateMac() bool {
	...
	if found {
		...
		appPath = strings.TrimSuffix(cmdPath, "basic.app/Contents/MacOS/basic")
		if err != nil {
...
func CheckForUpdate() (bool, string) {
	latest, found, err := selfupdate.DetectLatest("laszlo-lazuer/wails-poc")
	if err != nil {
